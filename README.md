...
Wrangler now supports parsing units like `KB`, `MB`, `ms`, and `s` directly in recipes.  
You can use the new directive `aggregate-stats` to compute total/average size and duration from such values.
